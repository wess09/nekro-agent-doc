...
在上一章节中，您已经成功创建并运行了一个简单的插件。本章节将带您深入了解构成 Nekro Agent 插件的各个核心概念。掌握这些概念是开发更复杂、功能更强大插件的基础。
...
3.  **[插件配置](./02_plugin_basics/2.3_configuration.md)**：了解如何为您的插件添加可由用户自定义的配置项，并通过 WebUI 进行管理。
