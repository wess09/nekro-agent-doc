...
欢迎来到 Nekro Agent 插件开发的世界！本指南将引导您从零开始学习如何为 Nekro Agent 创建强大且富有创意的插件。
...
Nekro Agent 插件几乎可以实现任何您希望 Agent 完成的任务，例如：
...
插件的类型多种多样，从简单的工具调用到复杂的业务逻辑处理，您可以充分发挥想象力。
