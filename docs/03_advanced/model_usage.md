...
| gemini-2.5-flash                  | 🥇   | 🥇   | 🥇   | 👑     | 👁️   | ❌       | 性价比较高，速度较快，拥有均衡的逻辑能力与语言能力，适合主力模型     |
| gemini-2.5-flash-thinking         | 🥇   | 🥈   | 🥉   | 👑     | 👁️   | 🧠       | 速度稍快的内置思维模型，生成质量较高但生成速度波动大                 |
...
| gemini-3-pro-preview              | 👑   | 🥉   | 🥈   | 🥉     | 👁️   | 🧠   | 谷歌最新高质量主力模型，编程领域表现优秀 |
| gemini-2.5-pro-exp-03-25-thinking | 👑   | 🥉   | 🥈   | 🥉     | 👁️   | 🧠   | 谷歌上代思考主力模型，编程领域表现尚可   |
| gemini-2.5-pro-exp-03-25          | 🥇   | 🥇   | 🥈   | 🥈     | 👁️   | ❌   | 谷歌上代非思考主力模型，编程领域表现尚可 |
...
| ------------------------------ | ---- | ---- | ---- | ------ | ------ | ------------ | -------------------------------------------------- |
| gemini-2.5-flash-image-preview | 🥇   | 🥇   | 🥈   | 🥇     | ✅     | 聊天模式     | Gemini 2.5 绘图模型                                |
