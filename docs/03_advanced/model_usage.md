...
> 本列表更新 2025 年 12 月 10 日

| 模型名称                          | 质量 | 速度 | 稳定 | 性价比 | 视觉 | 内置思维 | 备注                                                                 |
| --------------------------------- | ---- | ---- | ---- | ------ | ---- | -------- | -------------------------------------------------------------------- |
| claude-4-5-sonnet-latest          | 👑   | 🥈   | 🥈   | 🥈     | 👁️   | ❌       | Anthropic 的最新主力模型，综合能力最强但供应有限，适合主力模型       |
| gemini-3-pro-preview              | 👑   | 🥉   | 🥇   | 🥉     | 👁️   | 🧠       | 谷歌最新高质量主力模型，具备强大的智能体和编码能力，支持思考签名和思考等级 ⚠️ 预览版模型 |
| gemini-2.5-pro                    | 👑   | 🥇   | 🥇   | 🥈     | 👁️   | 🧠       | 综合体验最佳，语言能力、逻辑能力各方面性能均较好，具备自适应思考能力，适合主力模型 ⚠️ 预计最早于 2026 年 6 月停用，建议更换为 `gemini-3-pro` |
| gpt-4.1                           | 🥇   | 🥈   | 🥇   | 🥈     | 👁️   | ❌       | GPT 较新主力模型，AI 特征较明显，但逻辑能力尚可                      |
| claude-4-5-haiku                  | 🥈   | 🥇   | 🥇   | 🥉     | 👁️   | ❌       | Anthropic 的小模型，对标 gpt-4o-mini 水平                            |
| gemini-2.5-flash                  | 🥇   | 🥇   | 🥇   | 👑     | 👁️   | ❌       | 性价比较高，速度较快，拥有均衡的逻辑能力与语言能力，适合主力模型 ⚠️ 预计最早于 2026 年 6 月停用 |
| gemini-2.5-flash-thinking         | 🥇   | 🥈   | 🥉   | 👑     | 👁️   | 🧠       | 速度稍快的内置思维模型，生成质量较高但生成速度波动大 ⚠️ 预计最早于 2026 年 6 月停用 |
| deepseek-chat (v3)                | 🥇   | 🥉   | 🥇   | 🥈     | ❌   | ❌       | 经典的国产模型、中文能力优秀、语言风格鲜明                           |
| doubao-1.5-vision-pro-32k-250115  | 🥈   | 🥈   | 👑   | 🥈     | 👁️   | ❌       | 字节提供的国产模型、稳定性较好、多模态能力强、价格稳定、适合备用模型 |
| gemini-2.0-flash                  | 🥈   | 👑   | 🥇   | 🥇     | 👁️   | ❌       | 极低成本且快速的小模型，建议搭配外置思维链使用，也可作为迭代模型使用 ⚠️ 预计最早于 2026 年 2 月停用，建议更换为 `gemini-2.5-flash` |
| gpt-4o                            | 🥇   | 🥈   | 🥇   | 🥈     | 👁️   | ❌       | GPT 生成的 AI 味较重，适合生产力使用                                 |
| gpt-4o-mini                       | 🥈   | 🥈   | 🥇   | 🥇     | 👁️   | ❌       | GPT 生成的 AI 味较重，适合生产力使用                                 |
| grok-3                            | 🥈   | 🥈   | 🥇   | 🥉     | 👁️   | ❌       | xAI 推出的语言模型，限制较少，AI 味较低，适合用于对话                |
...
| gemini-3-pro-preview              | 👑   | 🥉   | 🥈   | 🥉     | 👁️   | 🧠   | 谷歌最新高质量主力模型，编程领域表现优秀，具备强大的智能体和编码能力 ⚠️ 预览版模型 |
| gemini-2.5-pro                    | 👑   | 🥇   | 🥇   | 🥈     | 👁️   | 🧠   | 谷歌上代主力模型，编程领域表现优秀，具备自适应思考能力 ⚠️ 预计最早于 2026 年 6 月停用，建议更换为 `gemini-3-pro` |

在生成模型生成修改建议后，我们还需要通过 `插件代码应用模型组(PLUGIN_APPLY_MODEL_GROUP)` 来在当前插件编辑器中应用修改建议，推荐使用强提示词遵循能力、生成速度快的模型，以下是推荐模型列表:

| 模型名称         | 质量 | 速度 | 稳定 | 性价比 | 视觉 | 思维 | 备注 |
| ---------------- | ---- | ---- | ---- | ------ | ---- | ---- | ---- |
| gemini-2.5-flash | 🥈   | 👑   | 🥇   | 🥈     | 👁️   | ❌   | ⚠️ 预计最早于 2026 年 6 月停用 |
...
| ------------------------------ | ---- | ---- | ---- | ------ | ------ | ------------ | -------------------------------------------------- |
| gemini-2.5-flash-image-preview | 🥇   | 🥇   | 🥈   | 🥇     | ✅     | 聊天模式     | Gemini 2.5 绘图模型 ⚠️ 将于 2026 年 1 月 15 日关闭 |
| gemini-3-pro-image-preview     | 🥇   | 🥇   | 🥈   | 🥉     | ✅     | 聊天模式     | Gemini 3 绘图模型，建议搭配高级绘图插件使用 (市场) |
