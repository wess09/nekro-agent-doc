---
title: Data Storage
description: "Learn how to use the two storage methods for Nekro Agent plugins: KV key-value storage (plugin.store) and plugin persistent directory (plugin.get_plugin_path()), including use cases, best practices, and complete examples"
---
