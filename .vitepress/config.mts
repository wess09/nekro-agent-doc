          ...
          "/en/docs/docs": [
            {
              ...
              collapsed: true,
              items: [
                { text: "Overview", link: "/en/docs/docs/01_intro/overview" },
                { text: "Scenarios", link: "/en/docs/docs/01_intro/application_scenarios" },
                { text: "Incentive Plan", link: "/en/docs/docs/01_intro/event" },
                { text: "Recruitment", link: "/en/docs/docs/01_intro/recruitment" },
              ],
            },
            {
              text: "Quick Start",
              collapsed: true,
              items: [
                { text: "Quick Start", link: "/en/docs/docs/02_quick_start/quickstart" },
                {
                  text: "Deployment",
                  collapsed: true,
                  items: [
                    { text: "Linux", link: "/en/docs/docs/02_quick_start/deploy/linux" },
                    { text: "Windows", link: "/en/docs/docs/02_quick_start/deploy/windows" },
                    { text: "MacOS", link: "/en/docs/docs/02_quick_start/deploy/macos" }
                  ],
                },
                {
                  ...
                  collapsed: true,
                  items: [
                    { text: "Nekro-Agent-Toolkit", link: "/en/docs/docs/community/nekro-agent-toolkit" },
                    { text: "iStoreOS", link: "/en/docs/docs/community/iStoreOS" }
                  ]
                },
                {
                  text: "Configuration",
                  collapsed: true,
                  items: [
                    { text: "Protocol", link: "/en/docs/docs/02_quick_start/config/protocol" },
                    { text: "System", link: "/en/docs/docs/02_quick_start/config/system" },
                    { text: "Update", link: "/en/docs/docs/02_quick_start/config/update" },
                  ],
                },
              ],
            },
            {
              ...
              collapsed: true,
              items: [
                { text: "Model Config", link: "/en/docs/docs/03_advanced/model_config" },
                { text: "Model Selection", link: "/en/docs/docs/03_advanced/model_usage" },
                { text: "Persona Tips", link: "/en/docs/docs/03_advanced/persona_tips" },
                { text: "Session Persona", link: "/en/docs/docs/03_advanced/session_persona" },
                { text: "User Management", link: "/en/docs/docs/03_advanced/user_management" },
                { text: "Plugin Usage", link: "/en/docs/docs/03_advanced/plugin_usage" },
                { text: "Plugin Generator", link: "/en/docs/docs/03_advanced/plugin_generator" },
                { text: "Basic Commands", link: "/en/docs/docs/03_advanced/commands_basic" },
                { text: "Debug Commands", link: "/en/docs/docs/03_advanced/commands_debug" },
              ],
            },
            {
              text: "Plugin Dev",
              collapsed: true,
              items: [
                { text: "Introduction", link: "/en/docs/docs/04_plugin_dev/00_introduction" },
                { text: "Quick Start", link: "/en/docs/docs/04_plugin_dev/01_quick_start" },
                {
                  text: "Core Concepts",
                  link: "/en/docs/docs/04_plugin_dev/02_plugin_basics",
                  collapsed: true,
                  items: [
                    { text: "Instance & Lifecycle", link: "/en/docs/docs/04_plugin_dev/02_plugin_basics/2.1_plugin_instance" },
                    { text: "Sandbox Methods", link: "/en/docs/docs/04_plugin_dev/02_plugin_basics/2.2_sandbox_methods" },
                    { text: "Configuration", link: "/en/docs/docs/04_plugin_dev/02_plugin_basics/2.3_configuration" },
                    { text: "Storage", link: "/en/docs/docs/04_plugin_dev/02_plugin_basics/2.4_storage" },
                    { text: "Prompt Injection", link: "/en/docs/docs/04_plugin_dev/02_plugin_basics/2.5_prompt_injection" },
                    { text: "Context Object", link: "/en/docs/docs/04_plugin_dev/02_plugin_basics/2.6_agent_context" },
                  ],
                },
                {
                  text: "Advanced",
                  link: "/en/docs/docs/04_plugin_dev/03_advanced_features",
                  collapsed: true,
                  items: [
                    { text: "Webhooks (Deprecated)", link: "/en/docs/docs/04_plugin_dev/03_advanced_features/3.1_webhooks" },
                    { text: "File Interaction", link: "/en/docs/docs/04_plugin_dev/03_advanced_features/3.2_file_interaction" },
                    { text: "Vector Database", link: "/en/docs/docs/04_plugin_dev/03_advanced_features/3.3_vector_database" },
                    { text: "Dynamic Router", link: "/en/docs/docs/04_plugin_dev/03_advanced_features/3.4_dynamic_router" },
                    { text: "Dynamic Package", link: "/en/docs/docs/04_plugin_dev/03_advanced_features/3.5_dynamic_package_import" },
                  ],
                },
                { text: "System API", link: "/en/docs/docs/04_plugin_dev/04_system_api_reference" },
              ],
            },
            {
              text: "App Dev",
              collapsed: true,
              items: [
                { text: "Linux Dev Env", link: "/en/docs/docs/05_app_dev/dev_linux" },
                { text: "Windows Dev Env", link: "/en/docs/docs/05_app_dev/dev_win" },
                { text: "MacOS Dev Env", link: "/en/docs/docs/05_app_dev/dev_macos" },
              ],
            },
            {
              ...
              collapsed: true,
              items: [
                { text: "FAQ", link: "/en/docs/docs/06_troubleshooting/faq" },
              ],
            },
          ]
        }
